...
from ..views.oj import (ApplyResetPasswordAPI, ResetPasswordAPI,
                        ...
                        UserContestSummaryAPI, UserContestDetailAPI, ContestCalibrateAPI)
...
urlpatterns = [
    ...
    url(r"^profile/contests/?$", UserContestSummaryAPI.as_view(), name="user_contest_summary_api"),
    url(r"^profile/contest_detail/?$", UserContestDetailAPI.as_view(), name="user_contest_detail_api"),
    url(r"^profile/contest_calibrate/?$", ContestCalibrateAPI.as_view(), name="contest_calibrate_api"),
