export const m = {
  ...
  Hint: '提示',
  Source: '題目來源',
  TestCase_Download_Title: '測資',
  TestCase_Download_Description: '如果你需要離線除錯或自測，可以直接下載這題的測資：',
  TestCase_Download_Button: '下載測資',
  Status: '狀態',
  Information: '題目資訊',
  Time_Limit: '時間限制',
  Memory_Limit: '記憶體限制',
  ...
  Keyword: '關鍵字',
  Problem_List: '試題列表',
  Problem_Search_Title: '帶著標籤去找題',
  Problem_Search_Subtitle: '先搜尋題目，再用難度與標籤縮小範圍；打開學習視圖後，可以直接在列表中掃讀演算法標籤。',
  Problem_Search_Placeholder: '搜尋題號、標題或你記得的關鍵字',
  Tag_Search_Placeholder: '在標籤裡搜尋你想篩選的內容',
  Problem_Search_Summary: '道題符合目前條件',
  Active_Filters: '目前篩選',
  Current_Tag: '已選標籤',
  Clear_Filter: '清除',
  Popular_Tags: '常用標籤',
  Tag_Search_Result: '匹配標籤',
  More_Tags: '更多標籤',
  No_Tags_Found: '沒有找到符合的標籤',
  Expand_Tags: '展開更多標籤',
  Collapse_Tags: '收起標籤',
  Show_Source: '顯示來源',
  Show_Source_Help: '在題目列表中顯示來源',
  Study_View: '顯示標籤',
  Study_View_Help: '在題目列表中顯示標籤',
  Search: '搜尋',
  On: '開',
  Off: '關',
  High: '高級',
